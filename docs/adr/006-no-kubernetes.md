...
- [Lambda vs ECS Guide](../lambda-vs-ecs.md) — decision framework for compute
- [Architecture](../architecture.md) — system overview
- [ADR-005: Lambda Default](./005-lambda-default-ecs-escape.md) — the alternative to Kubernetes
